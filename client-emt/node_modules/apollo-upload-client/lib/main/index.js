...
var createUploadLink = function createUploadLink() {
  ...
  return new _apolloLink.ApolloLink(function(operation) {
    ...
    var payload = (0, _apolloLinkHttpCommon.serializeFetchParameter)(
      body,
      'Payload'
    )
    ...
    return new _apolloLink.Observable(function(observer) {
      ...
      linkFetch(uri, options)
        ...
        .then((0, _apolloLinkHttpCommon.parseAndCheckHttpResponse)(operation))
